                        ...
                        <form method="post"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('category_id') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-role">{{ __('Category') }}</label>
                                ...
                                <div class="form-group{{ $errors->has('photo') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-name">{{ __('Picture') }}</label>
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label"
                                               for="input-picture">{{ __('Select picture') }}</label>
                                    </div>
                                ...
                                <div class="form-group{{ $errors->has('tags') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-role">{{ __('Tags') }}</label>
                                    <select name="tags[]"
                                            id="input-role"
                                            class="selectpicker{{ $errors->has('tags') ? ' is-invalid' : '' }}"
                                            placeholder="{{ __('Tags') }}"
                                        ...
                                        <option value="{{ $tag->id }}"
                                                {{
                                                in_array($tag->id, old('tags', $item->tags->pluck('id')->toArray()) ??
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                           for="input-role">{{ __('Status') }}</label>
                                    ...
                                    <div class="custom-control custom-radio mb-3">
                                        <input name="status"
                                               ...
                                               {{
                                               old('status',
                                               $item->status) == $value ? ' checked=checked' : '' }}>
                                        <label class="custom-control-label"
                                               for="{{ $value }}">{{ $status }}</label>
                                    </div>
                                    @endforeach
                                ...
                                <div class="form-group">
                                    <label class="form-control-label"
                                           for="input-role">{{ __('Show on homepage') }}</label>
                                    <div class="custom-field">
                                        <label class="custom-toggle">
                                            <input name="show_on_homepage"
                                                   type="checkbox"
                                                   value="1"
                                                   {{
                                                   old('show_on_homepage',
                                                   $item->show_on_homepage) ? ' checked=checked' : ''}}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input class="custom-control-input"
                                               ...
                                               {{
                                               (old('options',
                                               $item->options) && in_array($key, old('options', $item->options)))
                                        ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                               for="option-{{ $key }}">
                                            {{ $option }}
